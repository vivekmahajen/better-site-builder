...
async function insertOrder(pool, o) {
  ...
  try {
    ...
    await client.query(
      `INSERT INTO orders (id,puja,temple,devotee,gotra,priest,status,created_at)
       VALUES ($1,$2,$3,$4,$5,$6,$7,$8)
       ON CONFLICT (id) DO NOTHING`,
      [o.id, o.puja, o.temple, o.devotee, o.gotra ?? null, o.priest, o.status, o.created_at]
    );
...
export async function createBooking({ puja, temple, devotee, gotra, priest }) {
  await ensureReady();
  const pool = getPool();
