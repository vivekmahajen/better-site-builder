...
// NOTE: per-puja "officiating priest" is shown as a neutral, honest descriptor
// ("Verified pandit", assigned on booking confirmation) — NOT a fabricated named
// person. The old placeholder names are quarantined in lib/demo-people.js, and
// real, sourced priests live in data/priests.json (see lib/data/index.js).
const VERIFIED_PANDIT = "Verified pandit";
...
// Verified astrologer listings come from the Sacred Data Engine (sourced only).
// Empty until real, consenting practitioners are ingested — never fabricated.
export { verifiedAstrologers as ASTROLOGERS_SOURCE } from "./data/index.js";
