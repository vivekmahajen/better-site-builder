...
export const LIVE = [
  ...
  { temple: "Siddhivinayak", city: "Mumbai", ritual: "Kakad Aarti", time: "Live now", live: true, viewers: "9.1k", channel: "UCNH47WOVuA2zkP2cP1sEynw" },
  { temple: "Mahakaleshwar", city: "Ujjain", ritual: "Bhasma Aarti", time: "Live now", live: true, viewers: "21.7k", channel: "UCXhail7h5FDRbHprlR56nIw" },
  { temple: "Vaishno Devi", city: "Katra", ritual: "Atka Aarti", time: "6:30 PM today", live: false, viewers: "—", channel: null },
  { temple: "Golden Temple", city: "Amritsar", ritual: "Palki Sahib", time: "9:45 PM today", live: false, viewers: "—", channel: null },
  { temple: "Jagannath", city: "Puri", ritual: "Sandhya Aarti", time: "7:00 PM today", live: false, viewers: "—", channel: null },
];

// Fallback live-darshan channel (BHAKTI LIVE) when a temple has no dedicated stream.
export const LIVE_FALLBACK_CHANNEL = "UCXhail7h5FDRbHprlR56nIw";
